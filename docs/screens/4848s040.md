...
The home screen uses a **3-row × 3-column** grid, giving you **9 button slots**. Any button can be turned into a [subpage](/buttons-and-icons#subpages) folder containing up to 8 more buttons.
